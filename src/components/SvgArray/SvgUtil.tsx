...
function SvgDocumentManual() {
    return (
        ...
        <path d="M406.245 56L211 251.38V307H264.95L461 110.814L406.245 56Z" fill="#e8d4b0" stroke="black" strokeWidth="40" className="fill"/>
        <path d="M406.245 56L211 251.38V307H264.95L461 110.814L406.245 56Z" stroke="black" strokeWidth="40"/>
        </svg>
    )
}
