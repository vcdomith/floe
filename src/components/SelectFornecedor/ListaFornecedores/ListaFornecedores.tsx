...
const ListaFornecedores = async ({ fornecedoresRef, display, setDisplay, setFornecedor, selectIndex }: ListaFornecedoresProps) => {

    const fornecedores: ({nome: string}[] | null) = await getFornecedores()
