...
// import style from './ImportCardOld.module.scss'
...
// export default function ImportCardOld( { tipo, documento }: ImportCardProps ){
...
//             </span>
//             <Chave documento={documento} />
//             <button className={style.importButton}>Importar</button>
