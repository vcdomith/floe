...
function Produto({ mostrarFatores, index, controleProdutos, setControleProdutos, produto, getIndex, setFatores, setValor, setModalDisplay }: ProdutoProps) {
    ...
    return (
        <div  
                ...
                // transition={{duration: `${400+(50*(controleProdutos.length))}ms`}}
...
// const Produto = forwardRef(function Produto(props: ProdutoProps, ref) {

//     const { index, controleProdutos, setControleProdutos, produto, getIndex, setFatores, setValor, setModalDisplay } = props
